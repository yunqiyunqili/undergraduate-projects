...
int main()
{
    ...
    for (int i = 0; i < moon_height; i++)
    {
        ...
        {
            y[i * moon_width + j] = Mask(y, i, j, moon_height, moon_width, Sobel, 3);
        }
    }
    ...
    FILE *fout = fopen("/Users/yunqili/Documents/本科课程作业/大三上/数字视频处理/digital-video-processing/project3/lena_noise_Sobel.yuv", "wb");
    if (fout == NULL)
    {
